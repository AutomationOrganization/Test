...
import com.auto_honzmrzvan.alltypesdbautomation.Client;
import com.auto_honzmrzvan.alltypesdbautomation.service.ClientService;
 ...
 * @see Client
 */
@RestController("AllTypesDBAutomation.ClientController")
@Api(value = "ClientController", description = "Exposes APIs to work with Client resource.")
@RequestMapping("/AllTypesDBAutomation/Client")
public class ClientController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ClientController.class);

    @Autowired
	@Qualifier("AllTypesDBAutomation.ClientService")
