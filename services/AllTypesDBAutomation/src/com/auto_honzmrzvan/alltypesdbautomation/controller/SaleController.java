...
import com.auto_honzmrzvan.alltypesdbautomation.Sale;
import com.auto_honzmrzvan.alltypesdbautomation.service.SaleService;
 ...
 * @see Sale
 */
@RestController("AllTypesDBAutomation.SaleController")
@Api(value = "SaleController", description = "Exposes APIs to work with Sale resource.")
@RequestMapping("/AllTypesDBAutomation/Sale")
public class SaleController {

    private static final Logger LOGGER = LoggerFactory.getLogger(SaleController.class);

    @Autowired
	@Qualifier("AllTypesDBAutomation.SaleService")
