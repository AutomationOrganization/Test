 ...
 * @see VenueDetail
 */
@Service("AllTypesDBAutomation.VenueDetailService")
@Validated
public class VenueDetailServiceImpl implements VenueDetailService {
    ...
    @Autowired
    @Qualifier("AllTypesDBAutomation.VenueDetailDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service AllTypesDBAutomation for table VenueDetail to {} format", exportType);
