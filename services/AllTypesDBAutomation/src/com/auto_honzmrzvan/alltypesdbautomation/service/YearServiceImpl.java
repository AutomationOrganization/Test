 ...
 * @see Year
 */
@Service("AllTypesDBAutomation.YearService")
@Validated
public class YearServiceImpl implements YearService {
    ...
    @Autowired
    @Qualifier("AllTypesDBAutomation.YearDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service AllTypesDBAutomation for table Year to {} format", exportType);
