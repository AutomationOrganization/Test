 ...
 * @see Client
 */
@Service("AllTypesDBAutomation.ClientService")
@Validated
public class ClientServiceImpl implements ClientService {
    ...
    @Autowired
    @Qualifier("AllTypesDBAutomation.ClientDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service AllTypesDBAutomation for table Client to {} format", exportType);
