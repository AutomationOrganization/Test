 ...
 * @see AccountManager
 */
@Service("AllTypesDBAutomation.AccountManagerService")
@Validated
public class AccountManagerServiceImpl implements AccountManagerService {
    ...
    @Autowired
    @Qualifier("AllTypesDBAutomation.AccountManagerDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service AllTypesDBAutomation for table AccountManager to {} format", exportType);
