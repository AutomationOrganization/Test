...
package com.auto_honzmrzvan.dafssf.service;
...
public class Table1ServiceImpl implements Table1Service {
    ...
    @Transactional(value = "dafssfTransactionManager")
    @Override
	...
	@Transactional(readOnly = true, value = "dafssfTransactionManager")
	@Override
    ...
    @Transactional(readOnly = true, value = "dafssfTransactionManager")
	@Override
	public Table1 findById(Table1Id table1Id) {
        LOGGER.debug("Finding Table1 by id: {}", table1Id);
        return this.wmGenericDao.findById(table1Id);
    }


	@Transactional(rollbackFor = EntityNotFoundException.class, value = "dafssfTransactionManager")
	@Override
	public Table1 update(Table1 table1) throws EntityNotFoundException {
        ...
        table1Id.setColumn2(table1.getColumn2());
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dafssf for table Table1 to {} format", exportType);
