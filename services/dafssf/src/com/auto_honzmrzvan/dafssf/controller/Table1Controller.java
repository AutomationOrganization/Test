...
package com.auto_honzmrzvan.dafssf.controller;
...
import com.auto_honzmrzvan.dafssf.Table1;
import com.auto_honzmrzvan.dafssf.Table1Id;
import com.auto_honzmrzvan.dafssf.service.Table1Service;
...
@ApiOperation(value = "Returns the Table1 instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table1 getTable1(@RequestParam("id") Integer id,@RequestParam("column2") String column2) throws EntityNotFoundException {

        Table1Id table1Id = new Table1Id();
        table1Id.setId(id);
        table1Id.setColumn2(column2);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table1 editTable1(@RequestParam("id") Integer id,@RequestParam("column2") String column2, @RequestBody Table1 table1) throws EntityNotFoundException {

        table1.setId(id);
        table1.setColumn2(column2);

        LOGGER.debug("Table1 details with id is updated with: {}" , table1);

        return table1Service.update(table1);
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable1(@RequestParam("id") Integer id,@RequestParam("column2") String column2) throws EntityNotFoundException {
